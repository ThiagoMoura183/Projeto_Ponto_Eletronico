...
class WorkingHours extends Model {
    ...
    public function getActiveClock() {
        ...
        // Não bateu o primeiro ponto OU está no horário de almoço
    ...
    public function innout($time) {
        ...
        if (!$timeColumn) {
            throw new AppException("Você já registrou todos os 4 pontos do dia");
        }
    ...
    function getBalance() {
        ...
        if($this->work_date === DAILY_TIME) return '-';
